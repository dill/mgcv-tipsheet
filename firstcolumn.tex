...
\begin{block}{The main functions in \mgcv}
  ...
  \inline{bam}\\For fitting big additive models. Includes some special tricks for fitting to large datasets. (See options \texttt{discrete}, \texttt{cluster} and \texttt{nthreads}.)\br
  \vskip-1ex
\end{block}
...
\begin{seeblock}{Formula}{\texttt{formula=}}
  ...
  \inline{ti()} interaction via tensor product (ANOVA decomposition)\br
